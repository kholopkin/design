! function(t, e, i, n) {
    ...
    function n() {
        $(".header--nav-toggle").click(function() {
            ...
            }, 300), $(".outer-nav, .outer-nav li, .outer-nav--return").removeClass("is-vis")
        })
    }
    ...
    $('input[name=history]').change(function() {
            if (this.value == 'first') {
                $('#h-second').css("display","none");
                $('#h-third').css("display","none");
                $('#h-fourth').css("display","none");
                $('#h-first').css("display","block");
                $('#h-second').css("height","0");
                $('#h-third').css("height","0");
                $('#h-fourth').css("height","0");
                $('#h-first').css("height","260px");
                $('label[for=first]').css("color","#0f33ff");
                $('label[for=second]').css("color","#ffffff");
                $('label[for=third]').css("color","#ffffff");
                $('label[for=fourth]').css("color","#ffffff");
            }
            else if (this.value == 'second') {
                $('#h-first').css("display","none");
                $('#h-third').css("display","none");
                $('#h-fourth').css("display","none");
                $('#h-second').css("display","block");
                $('#h-second').css("height","260px");
                $('#h-third').css("height","0");
                $('#h-fourth').css("height","0");
                $('#h-first').css("height","0");
                $('label[for=first]').css("color","#ffffff");
                $('label[for=second]').css("color","#0f33ff");
                $('label[for=third]').css("color","#ffffff");
                $('label[for=fourth]').css("color","#ffffff");
            }
                ...
                $('#h-second').css("display","none");
                $('#h-fourth').css("display","none");
                $('#h-third').css("display","block");
                $('#h-second').css("height","0");
                $('#h-third').css("height","260px");
                $('#h-fourth').css("height","0");
                $('#h-first').css("height","0");
                $('label[for=first]').css("color","#ffffff");
                $('label[for=second]').css("color","#ffffff");
                $('label[for=third]').css("color","#0f33ff");
                $('label[for=fourth]').css("color","#ffffff");
            }
                ...
                $('#h-second').css("display","none");
                $('#h-third').css("display","none");
                $('#h-fourth').css("display","block");
                $('#h-second').css("height","0");
                $('#h-third').css("height","0");
                $('#h-fourth').css("height","260px");
                $('#h-first').css("height","0");
                $('label[for=first]').css("color","#ffffff");
                $('label[for=second]').css("color","#ffffff");
                $('label[for=third]').css("color","#ffffff");
                $('label[for=fourth]').css("color","#0f33ff");
            }
        });